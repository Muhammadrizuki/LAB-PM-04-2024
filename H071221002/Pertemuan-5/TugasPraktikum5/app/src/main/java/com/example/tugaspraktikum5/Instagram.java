...
public class Instagram implements Parcelable {
    ...
    public Instagram(String fattsyach, String FattahSyach, String konten, int fattah3, Uri selectedImageUri) {
        this.username = fattsyach;
        this.name = FattahSyach;
        this.desc = konten;
        this.fotoProfile = fattah3;
