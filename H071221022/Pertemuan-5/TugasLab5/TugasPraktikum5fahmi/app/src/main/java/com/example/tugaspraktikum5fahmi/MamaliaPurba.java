...
public class MamaliaPurba implements Parcelable {
    ...
    public MamaliaPurba(String username, String name, String desc, int fotoProfile, int fotoPostingan) {
    ...
    public MamaliaPurba(String username, String umji, String konten, int umji1, Uri selectedImageUri) {
        this.username = username;
        this.name = umji;
        this.desc = konten;
    ...
    protected MamaliaPurba(Parcel in) {
    ...
    public static final Creator<MamaliaPurba> CREATOR = new Creator<MamaliaPurba>() {
        @Override
        public MamaliaPurba createFromParcel(Parcel in) {
            return new MamaliaPurba(in);
        }

        @Override
        public MamaliaPurba[] newArray(int size) {
            return new MamaliaPurba[size];
        }
    };
