    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_posting.setOnClickListener(btn ->{
            ...
            if (konten.isEmpty()) {
                ...
                MamaliaPurba mamaliaPurba = new MamaliaPurba("Gajah Purba", "Raksasa Era Es", konten, R.drawable.gajah_purba, selectedImageUri);

                Bundle bundle = new Bundle();
                bundle.putParcelable(HomeFragment.EXTRA, mamaliaPurba);
